...
// 影の設定処理
//=============================================================================
void CBillboard::SetShadow(bool bOnShadow, float fHeight)
{
	if (bOnShadow == true && m_pShadow == NULL)
	{
		...
		m_pShadow->SetShadow(D3DXVECTOR3(m_pos.x, m_pos.y - m_size.y / 2 + fHeight, m_pos.z), 0.0f);
	}
}
