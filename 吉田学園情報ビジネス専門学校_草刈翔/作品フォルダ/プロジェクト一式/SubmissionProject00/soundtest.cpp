...
HRESULT CSoundTest::Init(D3DXVECTOR3 pos, D3DXVECTOR3 size)
{
	...
	// サウンドナンバー
	m_pSoundNumber = CSoundNumber::Create(D3DXVECTOR3(SOUNDTEST_UI_NUMBER_POS_X, SOUNDTEST_UI_NUMBER_POS_Y, 0.0f), D3DXVECTOR3(SOUNDTEST_UI_NUMBER_SIZE_X, SOUNDTEST_UI_NUMBER_SIZE_Y, 0.0f), D3DCOLOR_RGBA(255, 255, 255, 255));
